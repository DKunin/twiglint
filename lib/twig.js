...
const twigTrans = require('./extenders/trans-twig-extention');
const twigAutoescape = require('./extenders/autoescape-twig-extention');
...
twig.extend(twigJS);
twig.extend(twigTrans);
twig.extend(twigAutoescape);
